...
5. **同步 [jd-bank/](jd-bank/)**：按 [jd-bank/_jd-template.md](jd-bank/_jd-template.md) 写一份 `<slug>.md`，更新 [jd-bank/_index.md](jd-bank/_index.md)，文件末尾加一行 `> 📊 HTML 报告：./output/offer-strategy-<slug>.html`。
